          ...
          <div>
            ...
            <div className="flex gap-3">
              <button 
                ...
                className={clsx("flex-1 px-4 py-2.5 rounded-lg border text-sm font-bold transition-colors", reviewDecision === 'Approve' ? "bg-blue-700/10 border-[#3B72F6] text-blue-800 dark:bg-[rgba(59,114,246,0.12)] dark:text-[#3B72F6]" : "bg-transparent border-[var(--border)] text-[var(--text-secondary)] hover:border-[#3B72F6]")}
              >
                {t('common.approve')}
              </button>
              <button 
