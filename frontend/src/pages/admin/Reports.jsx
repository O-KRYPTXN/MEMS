...
export default function Reports() {
  ...
  const columns = useMemo(() => [
    ...
    { key: 'name', label: t('reports.reportName'), render: val => <div className="truncate max-w-[260px] font-medium text-[#E2E8F0]">{val}</div> },
    ...
    { key: 'size', label: t('reports.size'), render: val => <span className="text-[#5A6A85] text-xs font-mono">{val}</span> },
    { key: 'id', label: t('reports.actions'), align: 'right',
      render: (val, row) => (
        <div className="flex justify-end gap-1.5">
          <button onClick={() => { setSelectedReport(row); setShowViewModal(true) }} className="w-7 h-7 rounded-md bg-[#1A2235] border border-[#1F2A40] flex items-center justify-center text-[#94A3B8] hover:text-[#E2E8F0] hover:bg-[#1F2A40]" title={t('reports.view')}>
          ...
          <button onClick={() => showToast(`Downloading ${row.name}...`, TOAST_COLORS.admin)} className="w-7 h-7 rounded-md bg-[#1A2235] border border-[#1F2A40] flex items-center justify-center text-[#94A3B8] hover:text-[#E2E8F0] hover:bg-[#1F2A40]" title={t('reports.download')}>
  ...
  return (
    <div className="flex flex-col gap-6 relative pb-10">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-[1.25rem] font-bold text-[#E2E8F0]">{t('reports.pageTitle')}</h1>
          <p className="mt-[3px] text-[0.8125rem] text-[#5A6A85]">{t('reports.pageSubtitle')}</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        <div className="lg:col-span-2 bg-[#181D2A] border border-[#1F2A40] rounded-xl p-5 flex flex-col">
          <div className="text-[0.875rem] font-bold text-[#E2E8F0] mb-4">{t('reports.pmComplianceTrend')}</div>
        ...
        <div className="lg:col-span-1 bg-[#181D2A] border border-[#1F2A40] rounded-xl p-5 flex flex-col items-center">
          <div className="text-[0.875rem] font-bold text-[#E2E8F0] mb-4 w-full text-left">{t('reports.monthlyFaultSummary')}</div>
        ...
        <div className="lg:col-span-2 bg-[#181D2A] border border-[#1F2A40] rounded-xl p-5 flex flex-col">
          <div className="text-[0.875rem] font-bold text-[#E2E8F0] mb-4">{t('reports.maintenanceCost')}</div>
          <div className="flex-1 min-h-[240px]">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="lg:col-span-1 bg-[#181D2A] border border-[#1F2A40] rounded-xl p-5 flex flex-col">
          <div className="text-[0.875rem] font-bold text-[#E2E8F0] mb-5">{t('reports.sparePartsConsumption')}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_280px] gap-5 mt-2">
        ...
        <div className="bg-[#181D2A] border border-[#1F2A40] rounded-xl flex flex-col">
          <div className="p-4 border-b border-[#1F2A40]">
            <div className="text-[0.875rem] font-bold text-[#E2E8F0]">{t('reports.generateReport')}</div>
          </div>
      ...
      <Modal
        ...
        title={
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[15px] font-bold text-[#E2E8F0] tracking-normal leading-tight">{t('reports.reportViewer')}</div>
      ...
      >
        <div className="p-5 bg-[#131720] rounded-xl h-[320px] overflow-y-auto text-[13px] text-[#E2E8F0] font-mono leading-relaxed mt-1 border border-[#1F2A40]">
          ...
          <div className="text-center mt-10 text-[#5A6A85] font-bold">{t('reports.endOfReport')}</div>
        </div>
      </Modal>
    </div>
  )
