    ...
    <div className="flex flex-col gap-6 relative pb-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: t('supDevices.operational'), value: stats.operational, icon: <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />, colorClass: 'bg-[rgba(74,222,128,0.12)] text-[#4ADE80]' },
          { label: t('supDevices.faulty'), value: stats.faulty, icon: <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />, colorClass: 'bg-[rgba(239,68,68,0.12)] text-[#F87171]' },
