...
export default function Profile() {
  ...
  return (
    <div className="flex flex-col gap-6 relative pb-10">
      <div>
        <h1 className="text-[1.25rem] font-bold text-[#E2E8F0]">{t('profile.pageTitle')}</h1>
        <p className="mt-[3px] text-[0.8125rem] text-[#5A6A85]">{t('profile.pageSubtitle')}</p>
      </div>
        ...
        <div className="bg-[#181D2A] border border-[#1F2A40] rounded-xl px-7 py-6 min-h-[400px]">
          {activeTab === 'profile' && (
            <div className="animate-fade-in">
              <h2 className="text-lg font-bold text-white">{t('profile.tabMyProfile')}</h2>
              <p className="text-xs text-[#5A6A85] mt-1 mb-6 pb-4 border-b border-[#1F2A40]">{t('profile.myProfileDesc')}</p>
          ...
          {activeTab === 'notif' && (
            <div className="animate-fade-in">
              <h2 className="text-lg font-bold text-white">{t('profile.tabNotifications')}</h2>
              <p className="text-xs text-[#5A6A85] mt-1 mb-6 pb-4 border-b border-[#1F2A40]">{t('profile.notificationsDesc')}</p>
              
              <div className="flex flex-col">
                <div className="flex justify-between items-center py-4 border-b border-[#1A2235]">
                  <div>
                    <div className="text-sm font-semibold text-white">{t('profile.emailAlerts')}</div>
                    <div className="text-xs text-[#5A6A85] mt-0.5">{t('profile.emailAlertsDesc')}</div>
                  </div>
                  <Toggle id="emailAlerts" checked={toggles.emailAlerts} onChange={() => toggleSetting('emailAlerts')} />
                </div>
                <div className="flex justify-between items-center py-4 border-b border-[#1A2235]">
                  <div>
                    <div className="text-sm font-semibold text-white">{t('profile.smsAlerts')}</div>
                    <div className="text-xs text-[#5A6A85] mt-0.5">{t('profile.smsAlertsDesc')}</div>
                  </div>
                  <Toggle id="smsAlerts" checked={toggles.smsAlerts} onChange={() => toggleSetting('smsAlerts')} />
                </div>
                <div className="flex justify-between items-center py-4 border-b border-[#1A2235]">
                  <div>
                    <div className="text-sm font-semibold text-white">{t('profile.pmReminders')}</div>
                    <div className="text-xs text-[#5A6A85] mt-0.5">{t('profile.pmRemindersDesc')}</div>
                  </div>
                  <Toggle id="pmReminders" checked={toggles.pmReminders} onChange={() => toggleSetting('pmReminders')} />
                </div>
                <div className="flex justify-between items-center py-4">
                  <div>
                    <div className="text-sm font-semibold text-white">{t('profile.lowStock')}</div>
                    <div className="text-xs text-[#5A6A85] mt-0.5">{t('profile.lowStockDesc')}</div>
                  </div>
          ...
          {activeTab === 'security' && (
            <div className="animate-fade-in">
              <h2 className="text-lg font-bold text-white">{t('profile.tabSecurity')}</h2>
              <p className="text-xs text-[#5A6A85] mt-1 mb-6 pb-4 border-b border-[#1F2A40]">{t('profile.securityDesc')}</p>
              ...
              <div className="mt-8 pt-6 border-t border-[#1F2A40]">
                <div className="flex justify-between items-center">
                  <div>
                    <div className="text-sm font-semibold text-white">{t('profile.twoFactor')}</div>
                    <div className="text-xs text-[#5A6A85] mt-0.5">{t('profile.twoFactorDesc')}</div>
                  </div>
          ...
          {activeTab === 'app' && (
            <div className="animate-fade-in">
              <h2 className="text-lg font-bold text-white">{t('profile.tabApplication')}</h2>
              <p className="text-xs text-[#5A6A85] mt-1 mb-6 pb-4 border-b border-[#1F2A40]">{t('profile.appDesc')}</p>
              ...
              <div className="flex flex-col">
                <div className="flex justify-between items-center py-4 border-b border-[#1A2235]">
                  <div>
                    <div className="text-sm font-semibold text-white">{t('profile.darkTheme')}</div>
                    <div className="text-xs text-[#5A6A85] mt-0.5">{t('profile.darkThemeDesc')}</div>
                  </div>
                  <Toggle id="darkTheme" checked={toggles.darkTheme} onChange={() => toggleSetting('darkTheme')} />
                </div>
                <div className="flex justify-between items-center py-4">
                  <div>
                    <div className="text-sm font-semibold text-white">{t('profile.compactView')}</div>
                    <div className="text-xs text-[#5A6A85] mt-0.5">{t('profile.compactViewDesc')}</div>
                  </div>
