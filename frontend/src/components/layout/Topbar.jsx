...
const Topbar = ({ title, onSearch, onNotificationClick }) => {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center gap-4 h-[60px] px-7 bg-[#131720] border-b border-[#1F2A40]">
      <h1 className="flex-1 text-base font-bold text-[#E2E8F0] truncate">{title}</h1>

      <div className="flex items-center gap-2 w-[220px] h-9 px-3 bg-[#1A2235] border border-[#1F2A40] rounded-lg shrink-0">
      ...
      <button
        ...
        className="relative flex items-center justify-center w-9 h-9 rounded-lg bg-[#1A2235] border border-[#1F2A40] text-[#94A3B8] hover:bg-[#1F2A40] hover:text-[#E2E8F0] transition-colors shrink-0"
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-[6px] right-[6px] w-2 h-2 rounded-full bg-[#EF4444] border-2 border-[#131720]" />
        )}
      </button>
